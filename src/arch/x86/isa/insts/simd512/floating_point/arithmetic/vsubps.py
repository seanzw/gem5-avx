...
def macroop VSUBPS_XMM_M {
    ...
    vsubf dest=xmm0, src1=xmm0v, src2=ufp1, size=4, VL=16, mask=maskka
    vclear dest=xmm2, destVL=16
};
...
def macroop VSUBPS_YMM_YMM {
    vsubf dest=xmm0, src1=xmm0v, src2=xmm0m, size=4, VL=32, mask=maskka
    vclear dest=xmm4, destVL=32
};

def macroop VSUBPS_YMM_M {
    ldfp256 ufp1, seg, sib, "DISPLACEMENT + 0", dataSize=32
    vsubf dest=xmm0, src1=xmm0v, src2=ufp1, size=4, VL=32, mask=maskka
    vclear dest=xmm4, destVL=32
};
...
def macroop VSUBPS_ZMM_ZMM {
    vsubf dest=xmm0, src1=xmm0v, src2=xmm0m, size=4, VL=64, mask=maskka
};
